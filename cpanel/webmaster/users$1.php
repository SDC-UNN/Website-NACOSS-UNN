...
if (isset($array['search_button']) || //$array from index.php
    ...
    try {
        ...
        } elseif (isset($array['activate_button'])) {
            $actionPerformed = true;
    ...
    $users = searchUsers($searchQuery, false, true, $sort_type, $order);
} else {
...
<div>
    ...
    <div class="row">
        ...
        if (empty($users) and !isset($array['search_button']) ) {
            ...
            ?>
            <div id="top">
                <form action="index.php?p=11" method="post">
                            ...
                            <tbody>
                                ...
                                for ($index = 0; $index < count($users); $index++) {
                                    ...
                                    <tr>                            
                                        ...
                                        <td class="text-left">
                                            <a href="index.php?p=13&url=<?= urlencode(CPANEL_URL . 'webmaster/?p=11&pg=' . $page) ?>&id=<?= $users[$index]['regno'] ?>&search=<?= urlencode($searchQuery) ?>&sort_type=<?= $sort_type ?>&sort_order=<?= $order ?>">
                                                preview
                                            </a>
                                        </td>
                                    </tr>
